...
vars:
    ...
    greenhouse_using_interview: false # Disable if you do not have INTERVIEW synced, or do not want to run the interview_enhanced and interview_scorecard_detail transform models
    greenhouse_using_interviewer: false # Disable if you do not have INTERVIEWER synced, or do not want to include interviewer/scorecard data in the interview_enhanced transform model
```
